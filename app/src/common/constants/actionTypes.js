...
// grouped actions
export const ACTIONS_WITH_BTS_ISSUES = 'btsIssuesActions';
...
export const ACTIONS_WITH_NOTIFICATION_RULE_SETTINGS = 'notificationRuleSettingsActions';
export const ACTIONS_WITH_NOTIFICATION_RULES = 'notificationRuleActions';
...
export const GROUP_TO_ACTION_MAP = {
  ...
  [ACTIONS_WITH_NOTIFICATION_RULE_SETTINGS]: [UPDATE_NOTIFICATION_SETTINGS],
...
export const ACTION_TO_GROUP_MAP = {
  [POST_ISSUE]: ACTIONS_WITH_BTS_ISSUES,
  [LINK_ISSUE]: ACTIONS_WITH_BTS_ISSUES,
  [UNLINK_ISSUE]: ACTIONS_WITH_BTS_ISSUES,
  ...
  [UPDATE_NOTIFICATION_SETTINGS]: ACTIONS_WITH_NOTIFICATION_RULE_SETTINGS,
  [CREATE_NOTIFICATION_RULE]: ACTIONS_WITH_NOTIFICATION_RULES,
  [UPDATE_NOTIFICATION_RULE]: ACTIONS_WITH_NOTIFICATION_RULES,
  [DELETE_NOTIFICATION_RULE]: ACTIONS_WITH_NOTIFICATION_RULES,

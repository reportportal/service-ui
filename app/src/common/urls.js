...
export const URLS = {
  ...
  launchesInfoUpdate: (projectKey) => `${urlBase}${projectKey}/launch/info`,
  ...
  projectDefectSubType: (projectKey) => `${urlBase}${projectKey}/settings/sub-type`,
  projectDeleteDefectSubType: (projectKey, id) => `${urlBase}${projectKey}/settings/sub-type/${id}`,
  ...
  projectNotificationConfiguration: (projectKey) => `${urlBase}project/${projectKey}/notification`,
  suite: (projectKey, suiteId) => `${urlBase}${projectKey}/item/${suiteId}`,

  notification: (projectKey) => `${urlBase}notification/${projectKey}`,
  notificationById: (projectKey, notificationId) =>
    `${urlBase}notification/${projectKey}/${notificationId}`,
  ...
  testItemsInfoUpdate: (projectKey) => `${urlBase}${projectKey}/item/info`,
  ...
  //! need to figure it out
  userUnasign: (projectKey) => `${urlBase}project/${projectKey}/unassign`,

  generateDemoData: (projectKey) => `${urlBase}demo/${projectKey}`,

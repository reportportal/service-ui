...
export const btsUserName = bindMessageToValidator(validate.btsUserName, 'btsUserNameHint');
export const btsPassword = bindMessageToValidator(validate.btsPassword, 'btsPasswordHint');

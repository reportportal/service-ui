...
export const SystemMessage = ({ header, caption, children, mode, contentByChildWidth }) => {
  return (
    <div className={cx('system-message', { contentByChildWidth })}>
...
SystemMessage.propTypes = {
  ...
  contentByChildWidth: PropTypes.bool,
};

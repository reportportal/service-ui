...
export const JiraSettings = (props) => {
  ...
  const authFieldsConfig = [
    ...
    },
    {
      ...
      message: formatMessage(COMMON_BTS_MESSAGES.projectKeyLabel),
    },
    {
      value: props.data.integrationParameters.username,
      message: formatMessage(messages.authorizedByTitle),
    },
  ];
...
//       id: 'createProjectIntegrationModal',
//       data: {
//         modalTitle: this.props.intl.formatMessage(messages.editAuthTitle),

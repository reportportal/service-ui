...
export const ADMIN_ALL_USERS_PAGE_EVENTS = {
  ...
  ADD_USER_BTN: {
    category: ADMIN_ALL_USERS_PAGE,
    action: 'Click on Btn Add User',
    label: 'Arise Modal Add User',
  },
  GENERATE_PASSWORD_BTN_ADD_USER_MODAL: {
    category: ADMIN_ALL_USERS_PAGE,
    action: 'Click on Generate password in Modal Add User',
    label: 'Generate password',
  },
  CLOSE_ICON_ADD_USER_MODAL: {
    category: ADMIN_ALL_USERS_PAGE,
    action: 'Click on Close Icon in Modal Add Users',
  ...
  MAKE_ADMIN_BTN: {
    category: ADMIN_ALL_USERS_PAGE,
    action: 'Click on label Make admin',
    label: 'Arise Modal Change role',
  },
  CLOSE_ICON_CHANGE_ROLE_MODAL: {
    category: ADMIN_ALL_USERS_PAGE,
    action: 'Click on Close Icon in Modal Change Role',

...
export const LAUNCH_ANALYZE_TYPES_TO_ANALYTICS_TITLES_MAP = {
  ...
  [ANALYZER_MODE.ALL]: 'all_previous_launches',
  [ANALYZER_MODE.LAUNCH_NAME]: 'all_previous_launches_with_the_same_name',
  [ANALYZER_MODE.CURRENT_LAUNCH]: 'only_current_launch',
  [ANALYZER_MODE.PREVIOUS_LAUNCH]: 'only_previous_launch_with_the_same_name',
  [ANALYZER_MODE.CURRENT_AND_THE_SAME_NAME]: 'current_and_all_previous_launches_with_the_same_name',
};

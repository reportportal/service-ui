...
export const LOG_PAGE_EVENTS = {
  ...
  LOG_LEVEL_FILTER: {
    ...
    label: 'Filter by selected parametr',
  },
  ...
  NEXT_ERROR: {
    // todo
    category: LOG_PAGE,
    action: 'Click on Bttn Next Error',
    label: 'Transition to next error page',
  },
  ...
  STACK_TRACE_LINK: {
    // todo
    category: LOG_PAGE,
    action: 'Click on Go to Stack Trace link in Stack Trace tab',
    label: 'Open Stack Trace log message',
  },
  ...
  SCREENSHOT_SWITCHER_POST_ISSUE_MODAL: {
    // todo
    category: LOG_PAGE,

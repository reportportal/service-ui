...
export const PLUGINS_PAGE_EVENTS = {
  CLICK_UPLOAD_BTN: {
    ...
    action: 'Click on Bttn Upload',
    label: 'Arise Modal Upload Plugin',
  },
  OK_BTN_UPLOAD_MODAL: {
    category: PLUGINS_MODAL,
    action: 'Click on Bttn Upload on Modal "Upload plugin"',
    label: 'Upload Plugin',
  },
  CANCEL_BTN_UPLOAD_MODAL: {
    category: PLUGINS_MODAL,
    action: 'Click on Bttn Cancel on Modal "Upload plugin"',
  ...
  CANCEL_BTN_UNINSTALL_PLUGIN_MODAL: {
    category: PLUGINS_MODAL,
    action: 'Click on Bttn Cancel on Modal "Uninstall Plugin"',
    label: 'Close Modal Uninstall Plugin',
  },
  OK_BTN_UNINSTALL_PLUGIN_MODAL: {
    category: PLUGINS_MODAL,
    action: 'Click on Bttn Uninstall on Modal "Uninstall Plugin"',

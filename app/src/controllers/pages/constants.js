...
// inside
export const TEST_CASE_LIBRARY_PAGE = 'TEST_CASE_LIBRARY_PAGE';
export const TEST_CASE_DETAILS_PAGE = 'TEST_CASE_DETAILS_PAGE';
...
export const EXPLORE_CLOUD_PAGE_INSTANCE_LEVEL = 'EXPLORE_CLOUD_PAGE_INSTANCE_LEVEL';
export const EXPLORE_CLOUD_PAGE_ORGANIZATION_LEVEL = 'EXPLORE_CLOUD_PAGE_ORGANIZATION_LEVEL';
export const EXPLORE_CLOUD_PAGE_PROJECT_LEVEL = 'EXPLORE_CLOUD_PAGE_PROJECT_LEVEL';
export const ORGANIZATIONS_PAGE = 'ORGANIZATIONS_PAGE';
export const ORGANIZATIONS_ACTIVITY_PAGE = 'ORGANIZATIONS_ACTIVITY_PAGE';
...
export const ORGANIZATION_SETTINGS_TAB_PAGE = 'ORGANIZATION_SETTINGS_TAB_PAGE';
...
export const MANUAL_LAUNCHES_PAGE = 'MANUAL_LAUNCHES_PAGE';
export const MANUAL_LAUNCH_DETAILS_PAGE = 'MANUAL_LAUNCH_DETAILS_PAGE';
export const MANUAL_LAUNCH_EXECUTION_PAGE = 'MANUAL_LAUNCH_EXECUTION_PAGE';
export const OAUTH_SUCCESS = 'OAUTH_SUCCESS';
export const PROJECT_MILESTONES_PAGE = 'PROJECT_MILESTONES_PAGE';
export const PROJECT_TEST_PLAN_DETAILS_PAGE = 'PROJECT_TEST_PLAN_DETAILS_PAGE';
// outside

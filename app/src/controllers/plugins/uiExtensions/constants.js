...
export const EXTENSION_TYPE_SETTINGS_GENERAL_TAB = 'uiExtension:settingsGeneralTab';
...
export const EXTENSION_TYPE_HEADER_COMPONENT = 'uiExtension:headerComponent';

...
export const DELETE_TEST_CASE = 'deleteTestCase' as const;
export const START_DELETING_TEST_CASE = 'startDeletingTestCase' as const;
export const STOP_DELETING_TEST_CASE = 'stopDeletingTestCase' as const;

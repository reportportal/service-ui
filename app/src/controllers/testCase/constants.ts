...
export const GET_FILTERED_FOLDERS = 'getFilteredFolders' as const;
export const SET_FILTERED_FOLDERS = 'setFilteredFolders' as const;
export const START_LOADING_FILTERED_FOLDERS = 'startLoadingFilteredFolders' as const;
export const STOP_LOADING_FILTERED_FOLDERS = 'stopLoadingFilteredFolders' as const;
export const CLEAR_FILTERED_FOLDERS = 'clearFilteredFolders' as const;

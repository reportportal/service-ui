...
export const clusterItemsSelector = (state, id) =>
  domainSelector(state).clusterItems[id] || INITIAL_STATE;
export const selectedClusterItemsSelector = createSelectedItemsSelector(groupOperationsSelector);

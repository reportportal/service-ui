...
export const LOG_TIME_FORMAT_ABSOLUTE = 'absolute';
export const LOG_TIME_FORMAT_EXTENDED = 'extended';

export const SETTINGS_INITIAL_STATE = {
  startTimeFormat: START_TIME_FORMAT_RELATIVE,
  logTimeFormat: START_TIME_FORMAT_ABSOLUTE,

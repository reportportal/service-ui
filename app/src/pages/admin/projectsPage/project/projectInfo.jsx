...
const messages = defineMessages({
  members: {
    id: 'ProjectInfo.members',
    defaultMessage: 'Members',
  },
  settings: {
    id: 'ProjectInfo.settings',
    defaultMessage: 'Settings',
  },
  assign: {
    id: 'ProjectInfo.assign',
    defaultMessage: 'Assign',
  },
  unassign: {
    id: 'ProjectInfo.unassign',
    defaultMessage: 'Unassign',
  },
  delete: {
    id: 'ProjectInfo.delete',
    defaultMessage: 'Delete',
  },
  launchesQuantity: {
    id: 'ProjectInfo.launchesQuantity',
    defaultMessage: 'Launches',
  },
  membersQuantity: {
    id: 'ProjectInfo.membersQuantity',
    defaultMessage: 'Members',
  },
  linkedTooltip: {
    id: 'ProjectInfo.linkedTooltip',
    defaultMessage: 'Synced with UPSA',
  },
  personalTooltip: {
    id: 'ProjectInfo.personalTooltip',

...
const messages = defineMessages({
  ...
  removeIndexDescription: {
    ...
    defaultMessage:
      'All data with your investigations will be deleted from the search engine. For creating a new one you could start to investigate test results manually or generate data based on previous results on the project once again',
  },

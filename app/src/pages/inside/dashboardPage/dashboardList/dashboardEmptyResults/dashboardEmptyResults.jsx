...
import styles from './dashboardEmptyResults.scss';
...
@injectIntl
export class DashboardEmptyResults extends Component {
  static propTypes = {
  ...
  render() {
    ...
    return (
      <div className={cx('empty-dashboard')}>
        {userDashboards ?
          (
            <Fragment>
          ...
          (
            <Fragment>
              ...
              <div className={cx('empty-dashboard-content')}>
                <GhostButton
                  onClick={action}
                > {intl.formatMessage(messages.currentUserDashboardsActionText)}</GhostButton>
              </div>
            </Fragment>
          )
        }

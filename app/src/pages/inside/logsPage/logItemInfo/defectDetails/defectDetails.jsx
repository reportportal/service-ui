...
const POST_ISSUE_EVENTS_INFO = {
  postBtn: LOG_PAGE_EVENTS.POST_ISSUE_MODAL_EVENTS.POST_BTN_POST_ISSUE_MODAL(MAKE_DECISION),
...
const LINK_ISSUE_EVENTS_INFO = {
  loadBtn: LOG_PAGE_EVENTS.LINK_ISSUE_MODAL_EVENTS.LOAD_BTN_LINK_ISSUE_MODAL(MAKE_DECISION),
...
const UNLINK_ISSUE_EVENTS_INFO = {
  unlinkBtn: LOG_PAGE_EVENTS.UNLINK_ISSUE_MODAL_EVENTS.UNLINK_BTN_UNLINK_ISSUE_MODAL(MAKE_DECISION),

...
export const messages = defineMessages({
  ...
  generateIndexDescription: {
    ...
    defaultMessage:
      'all data is removed from search engine and new one is generated based on all previous investigations on the project. You can start using auto-analysis after receiving an e-mail about the end of the generation process.',
  },

...
export const messages = defineMessages({
  tabDescription: {
    ...
    defaultMessage:
      'Besides known issues with selected defect types, there could be issues with a similar reason marked as «To investigate» defect types. All these items are displayed in the «Similar To Investigate» section in Defect editor modal. More information about Similar Items you can read in <a data-automation-id="documentationLink">Documentation</a>',
  },

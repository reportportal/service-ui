...
export const messages = defineMessages({
  ...
  searchLogsMinShouldMatchDescription: {
    ...
    defaultMessage:
      'Percent of words equality between a log from considered test item and a log from To Investigate item in the search engine. If a log from the search engine has the value less than set, this log won’t be shown in the similar To Investigate items section',
  },
});

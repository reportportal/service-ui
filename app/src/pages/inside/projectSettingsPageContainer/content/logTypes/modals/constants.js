...
export const LABEL_COLOR_FIELD_KEY = 'labelColor';
export const BACKGROUND_COLOR_FIELD_KEY = 'backgroundColor';
export const TEXT_COLOR_FIELD_KEY = 'textColor';
export const TEXT_BOLD_FIELD_KEY = 'textBold';

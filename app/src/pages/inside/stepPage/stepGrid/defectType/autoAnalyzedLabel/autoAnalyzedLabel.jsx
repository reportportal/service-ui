...
export const AutoAnalyzedLabel = injectIntl(({ intl, className, shortLabel }) => (
  <div
    className={cx('aa-label', { 'short-label': shortLabel }, className)}
    title={intl.formatMessage(messages.investigatedByAA)}
  >
    {shortLabel ? 'AA' : Parser(AAIcon)}
  </div>
));

...
import { UpdateTestCasePayload, useUpdateTestCase } from './useChangePriorityModal';
import { messages } from '../messages';
import { commonMessages } from '../../commonMessages';
import { PrioritySelect } from '../../prioritySelect/prioritySelect';

import styles from './changePriorityModal.scss';
...
}: InjectedFormProps<UpdateTestCasePayload> & ChangePriorityModalProps) => {
...
export default withModal(CHANGE_PRIORITY_MODAL_KEY)(
  reduxForm<UpdateTestCasePayload, ChangePriorityModalProps>({

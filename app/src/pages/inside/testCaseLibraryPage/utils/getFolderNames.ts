 ...
 * @returns Object with folderName and targetFolderName (targetFolderName will be "root folder" or "'FolderName'")
 */
export const getFolderNames = (
  ...
  return {
    ...
    targetFolderName: targetFolder ? `'${targetFolder.name}'` : 'root folder',
  };
};

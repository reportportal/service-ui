...
import styles from './ldapLoginForm.scss';
...
const LdapLoginFormComponent = ({ handleSubmit, form }) => {
  ...
  return (
    <form
      className={cx('ldap-login-form', { 'ldap-login-form--lockout': isLoginLimitExceeded })}
...
LdapLoginFormComponent.propTypes = {

...
define(function (require) {
    ...
    var eventTable = {
        ...
        512: ['Server Settings', 'Edit checkbox Help make ReportPortal better on tab Statistics', 'Check/uncheck Help make ReportPortal better on tab Statistics'],
        513: ['Server Settings', 'Click on Bttn Submit on tab Statistics', 'Submit changes on tab Statistics'],
        514: ['MB Header', 'Click on link API', 'Transition to API page'],
        515: ['Launches', 'Click on All Launches dropdown icon', 'Arise dropdown'],
        516: ['Launches', 'Select All Launches on dropdown ', 'Transition to All Launches'],
        517: ['Launches', 'Select Latest Launches in dropdown ', 'Transition to Latest Launches'],
        518: ['Launches', 'Click on Bttn Import', 'Arise Modul Import Launch'],
        519: ['Modul Launches', 'Click on Close Icon on Modul \'Import Launch\'', 'Close Modul Import Launch'],
        520: ['Modul Launches', 'Click on Bttn Cancel on Modul \'Import Launch\'', 'Close Modul Import Launch'],
        521: ['Modul Launches', 'Click on Bttn Ok on Modul \'Import Launch\'', 'Import Launch'],
        522: ['Modul Launches', 'Click on Bttn Linear Merge on Modul \'Merge Launches\'', 'Linear Merge'],
        523: ['Modul Launches', 'Click on Bttn Deep Merge on Modul \'Merge Launches\'', 'Deep Merge'],
        524: ['Suite', 'Click on dropdown icon on Save Bttnon Modul \'Edit Item\'', 'Arise dropdown'],
        525: ['Suite', 'Select Save and Post Bug on dropdown in Modul \'Edit Item\'', 'Arise Modul \'Post Bug\''],
        526: ['Suite', 'Select Save and Load Bug on dropdown in Modul \'Edit Item\'', 'Arise Modul \'Load Bug\''],
        527: ['Login', 'Click on twitter link', 'Open twitter link'],
        528: ['Login', 'Click on Icon Github on Welcome screen', 'Transition to Github'],
        529: ['Login', 'Click on Icon Facebook on Welcome screen', 'Transition to Facebook'],
        530: ['Login', 'Click on Icon Tweeter on Welcome screen', 'Transition to Tweeter'],
        531: ['Login', 'Click on Icon YouTube on Welcome screen', 'Transition to YouTube'],

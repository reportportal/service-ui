...
define(function (require) {
    ...
    var TimeRangeEntityView = Epoxy.View.extend({
        ...
        render: function () {
            this.$el.html(Util.templates(this.template, {}));
            this.ranges = {};
            this.ranges[Localization.filters.timeRangeToday] = [Moment().startOf('day'), Moment().endOf('day')];
            this.ranges[Localization.filters.timeRangeLast2Days] = [Moment().subtract(1, 'days').startOf('day'), Moment()];
            this.ranges[Localization.filters.timeRangeLast7Days] = [Moment().subtract(7, 'days').startOf('day'), Moment()];
            this.ranges[Localization.filters.timeRangeLast30Days] = [Moment().subtract(30, 'days').startOf('day'), Moment()];

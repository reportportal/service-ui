...
define(function (require) {
    ...
    var LogItemInfoAttachmentsView;
    ...
    var ItemAttachmentsModel = Epoxy.Model.extend({
        ...
        load: function () {
            ...
            if (this.get('pageNumber') < 1 || this.get('pageNumber') > this.get('totalPages')) {
                ...
                path = Urls.getLogsUrl() + '?' + this.getParamsUrl().join('&');
    ...
    ItemAttachmentView = Epoxy.View.extend({
    ...
    ItemAttachmentMainView = Epoxy.View.extend({
        tagName: 'li',
    ...
    LogItemInfoAttachmentsView = Epoxy.View.extend({
        ...
        updateLoadItems: function () {
            ...
            activeModel = this.currentLoadCollection.where({ active: true })[0];
        ...
        onChangeGalleryMainSlide: function (options) {
            ...
            if (options.dirrection === 'right') {
                ...
                options.galleryModels[options.index + 1].set(this.currentLoadCollection
                    .at(curIndex + 1).toJSON());
                if (options.galleryModels[options.index - 1].get('pageNumber') &&
                    options.galleryModels[options.index - 1].get('pageNumber') !==
                        options.galleryModels[options.index].get('pageNumber')) {
            ...
            if (!this.currentLoadCollection.at(curIndex - 1)) {
                ...
                .set(this.currentLoadCollection.at(curIndex - 1).toJSON());
            if (options.galleryModels[options.index + 1].get('pageNumber') !==
                    options.galleryModels[options.index].get('pageNumber')) {

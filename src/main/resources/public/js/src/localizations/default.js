...
define(['util'], function () {
    return {
        ...
        dashboard: {
            ...
            clickToAdd: "Add your first Dashboards to analyse statistics",
        ...
        launches: {
            ...
            finishWarning: "Warning! In case of finish the %%%, all data will be missed. Are you sure you want to finish %%%?",
        ...
        wizard: {
            ...
            ownFiltersAbsent: "No results to display",

...
define([], function () {
    ...
    var userDashboards = function () {
        return [
            ...
            },
            {
                ...
                owner: 'default',
                widgets: [
                    { widgetId: '5592637ee4b0eeaae6629a20', widgetPosition: [0, 47], widgetSize: [12, 7] },
                    { widgetId: '559298aae4b00cf07045df40', widgetSize: [5, 6], widgetPosition: [0, 41] }
                ]
            },
            {
    ...
    var getGadgetModelData = function () {
        return {
            widgetId: '5592637ee4b0eeaae6629a27',
            widgetPosition: [0, 47],
            widgetSize: [12, 7]
        };
    };

    var getWidgetsModelData = function () {
        return [
            {
                description: '',
    ...
    return {
        ...
        getToken: getToken,
        getGadgetModelData: getGadgetModelData,
        getWidgetsModelData: getWidgetsModelData
    };
});

...
define(function (require) {
    ...
    var LaunchBodyView = Epoxy.View.extend({
        ...
        onChangeLogItem: function (logItemId) {
            ...
            config.router.navigate(
                this.collectionItems.getPathByLogItemId(logItemId), { trigger: false }
            );
        },
        ...
        onChangeItemCrumbs: function (launchModel, parentModel, optionsURL, nextItemId) {
            ...
            this.collectionItems.update(launchModel, parentModel, optionsURL, this.crumbs)
                ...
                .always(function () {
                    ...
                    nextItemId && optionsURL
                    && self.body && self.body.activateNextId
                    && self.body.activateNextId(nextItemId);
                })
                .fail(function () {

...
define(function (require) {
    ...
    var IgnoreAAAction = Epoxy.View.extend({
        ...
        initialize: function (options) {
            ...
            modal = new ModalConfirm({
                headerText: Util.replaceTemplate(Localization.dialogHeader.ignoreAA, typeItems),
                bodyText: Util.replaceTemplate(Localization.dialog.msgIgnoreAA, itemName),
                cancelButtonText: Localization.ui.cancel,
                okButtonText: Localization.ui.ignore,
                okButtonDanger: true,
                confirmFunction: function () {
                    ...
                    _.each(items, function (item) {
                        ...
                        issue.ignoreAnalyzer = true;
                        data.issues.push({
                            test_item_id: item.get('id'),
                            issue: issue
                        });
                    }, this);
                    message = (items.length > 1) ? 'ignoreItemsAA' : 'ignoreItemAA';

...
To log in, open the application and enter valid credentials – login and password, and click "SIGN IN"
button.

[ ![Image](Images/pic_1.jpg) ](Images/pic_1.jpg)
...
NOTE: You should have access to "DEFAULT\_PROJECT" by default.Please avoid overusing "DEFAULT\_PROJECT", because this project is open for
every user, and your sensitive data can be seen by everyone.
 

### User roles in Report Portal
...
divided into 2 sections: "Active Projects" and "Not Active Projects".
...
**Note:**  
"DEFAULT\_PROJECT" cannot be deleted.
...
The project settings divided into four tabs: "General", "Notifications", "Bug Tracking
System" and "Defect types".
 
...
6. Click "Add Subtype" button under any default defect type
...
header and select "Profile" button.
...
**Note:**  
Password should have size at least 4 and not more than 25 symbols.
...
>   Red - failed. Contains link to related bug (if has it)

>   Grey - skipped. Contains link to related bug (if has it)

>   Green - passed. Contains only execution number

>   Grey with cross symbol - absent in particular run

>   Orange - a few items with the same name are presented

>   Colored with blue and animated - still without state [in progress]
...
>   Red - indicates the launches with failed cases
...
Report Portal provides the ability to connect JIRA, TFS and RALLY.
...
To integrate TFS to the project, perform following steps:
...
5. Select TFS in the "Bug Tracking System" drop-down and fill in TFS
    properties form.

6. [ ![Image](Images/pic_34.jpg) ](Images/pic_34.jpg)

7. Click "Submit" button. "Default properties for issue form" (list of fields provided for bug form in TFS) will appear. Required in TFS fields
    are marked with asterisk. They are checked by default and disabled for
    unchecking.

8. [ ![Image](Images/pic_40.jpg) ](Images/pic_40.jpg)

9. Check wanted fields. Checked fields will be shown on the post bug form.

10. Fill in the required fields and the other checked fields (if necessary), and
    click "Submit" button. The system will save the entered information
    and hide the fields that are not checked. All the saved information on the
    checked fields will be predefined, when you will post a bug to TFS.

11. [ ![Image](Images/pic_41.jpg) ](Images/pic_41.jpg)
...
To remove TFS from project settings, click "Remove project" button.

[ ![Image](Images/pic_42.jpg) ](Images/pic_42.jpg)


**Edit TFS properties**

To edit TFS properties, click "Edit" button. The TFS properties will become
editable.

[ ![Image](Images/pic_43.jpg) ](Images/pic_43.jpg)

Make changes in TFS properties form.
...
In order to post bug to TFS, perform the following steps:
...
8. [ ![Image](Images/pic_119.jpg) ](Images/pic_119.jpg)

9. Fill in the form and click "Submit" button.

10. The bug will be posted to the TFS and link to the bug will be displayed on the
Step and Log level of the failed item.

Hover the mouse over the bug and you will see issue status and summary on
tool-tip.

[ ![Image](Images/pic_120.jpg) ](Images/pic_120.jpg)
...
### Add link to TFS issue

To add link to existing TFS issue to Report Portal, perform the following steps:
...
5. Load bug pop-up form should be appeared.

6. [ ![Image](Images/pic_128.jpg) ](Images/pic_128.jpg)

7. Go to the TFS and copy link to issue.

8. [ ![Image](Images/pic_132.jpg) ](Images/pic_132.jpg)

9. Input link to issue and issue ID, add more issues (if need).

10. [ ![Image](Images/pic_133.jpg) ](Images/pic_133.jpg)

11. Click "Add" button. The link to the bug will be shown on the
    Step and Log level of the failed item.

12. [ ![Image](Images/pic_134.jpg) ](Images/pic_134.jpg)
